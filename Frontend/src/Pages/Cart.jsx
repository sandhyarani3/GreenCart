...
const Cart = () => {
    ...
    const {product,cartItems,currency,removeFromCart,getCartCount,updateCartItem,navigate,getCartAmount,axios,user,setCartItems}=useAppContext();
    ...
    const getCart=()=>{
        ...
        for(const key in cartItems){
            const product1=product.find((item)=>item._id===key)
            product1.quantity=cartItems[key];
            tempArray.push(product1);
        }
