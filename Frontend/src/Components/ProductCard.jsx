...
const ProductCard = ({product}) => {
    ...
    return product && (
        ...
        scrollTo(0,0)}} className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-56 max-w-56 w-full cursor-pointer">
                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div className="text-primary">
                        {!cartItems[product._id] ? (
                            <button className="flex items-center justify-center gap-1 bg-indigo-100 border border-indigo-300 md:w-[80px] w-[64px] h-[34px] 
                            rounded text-bg-primary font-medium cursor-pointer" 
